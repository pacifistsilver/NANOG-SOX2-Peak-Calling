...
def extract_peaks_from_bed(bed_file):
    ...
    converter = ChainFile('mm8ToMm9.over.chain.gz')
...
sox2_peaks = extract_peaks_from_bed('Sox2_Chen2008_peaks.narrowPeak')
nanog_peaks = extract_peaks_from_bed('Nanog_Chen2008_peaks.narrowPeak')
...
df.to_csv('h3k4me3_promoter_site_counts_chen2008.csv', index=False)
