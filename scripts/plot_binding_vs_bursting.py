...
plt.tight_layout()
plt.savefig('../plots/burst_freq_vs_binding_nature.pdf')
plt.savefig('../plots/burst_freq_vs_binding_nature.png', dpi=300)
...
plt.tight_layout()
plt.savefig('../plots/burst_size_vs_binding_nature.pdf')
plt.savefig('../plots/burst_size_vs_binding_nature.png', dpi=300)
